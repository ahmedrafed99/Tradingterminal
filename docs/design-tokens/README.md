...
| [ui.md](ui.md) | Font family, z-index stack, box shadows, border radii, transition durations | `frontend/src/constants/layout.ts` + `tokens.css` |

See also:
- [index.html](index.html) — Visual palette reference (open in browser)
