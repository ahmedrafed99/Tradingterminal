...
function ArrowPathIcon() {
  return (
    <svg width="26" height="26" viewBox="0 0 28 28" shapeRendering="geometricPrecision" fill="currentColor">
...
function MagnetIcon() {
  return (
    <svg width="26" height="26" viewBox="0 0 28 28" fill="currentColor" fillRule="nonzero">
...
export function DrawingToolbar() {
  ...
  return (
    ...
    >
      ...
      {showExpanded && (
        <div
          className={`flex flex-col bg-(--color-surface) border border-(--color-border) rounded-r-md ${
              ...
              <button
                ...
                className={`flex items-center justify-center ${
                  activeTool === id
                    ...
                    : 'text-(--color-text) hover:text-white hover:bg-(--color-border)/50'
                }`}
