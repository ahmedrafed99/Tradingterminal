...
**Target:** The **previous move to low (SOS)** — the move to low of the previous trend, where it was gained. Always the important previous SOS level (see [concepts.md](concepts.md) → Important Previous Sign of Strength).
...
**Target:** The **previous move to high (SOW)** — the move to high of the previous trend, where it was gained. Always the important previous SOW level (see [concepts.md](concepts.md) → Important Previous Sign of Weakness).
