  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="relative flex gap-1.5">
        ...
        >
          {placing === 'sell' ? (
            <span className="text-xs font-light text-(--color-text-bright)">...</span>
          ) : (
            <>
              <span className="text-xs font-light text-(--color-text-bright)">Sell {orderSize}</span>
              <span className="text-xs font-light text-(--color-text-bright) mt-0.5">
        ...
        >
          {placing === 'buy' ? (
            ...
            <>
              <span className="text-xs font-light text-(--color-text-bright)">Buy {orderSize}</span>
              <span className="text-xs font-light text-(--color-text-bright) mt-0.5">
